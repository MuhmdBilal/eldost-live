...
function Gold() {
  ...
  const wmpNftIntegrateContract = () => {
    const nft_Contract = new web3.eth.Contract(WMPNFTAbi, WMPNFTAddress);
    return nft_Contract;
  };
  ...
  const handleMint = async () => {
    try {
      if (walletAddress) {
        ...
        const collection = await wmpNftContract.methods.collections(2).call();
        ...
        if (Number(balanceOf) >= calculateValue) {
          ...
          await wmpNftContract.methods.mint(2).send({
            from: walletAddress,
          });
    ...
    try {
      if (walletAddress) {
        ...
        const response = walletOfOwner
          .filter((value) => Number(value) >= 226 && Number(value) <= 300)
          .map((value) => ({
            value: Number(value),
  ...
  return (
    <div className="goold" style={{ padding: "20% 0 0 0" }}>
      <div className="container py-4 ">
        ...
        <div className="row">
          ...
          {/* <div className="col-12 col-md-6">
            <div className="d-bolck d-md-flex  gap-2">
