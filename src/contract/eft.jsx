export const eftAddress = "0xb02eF03245fc7DF987BBd876768E6d441b7099B6";
export const eftAbi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "_icoWallet", type: "address" },
      ...
      { internalType: "address", name: "_listingWallet", type: "address" },
      {
        internalType: "address",
        name: "_nftDevelopmentWallet",
        type: "address",
      },
      { internalType: "address", name: "_liquidityWallet", type: "address" },
      {
        internalType: "address",
        name: "_futureInnovationsWallet",
        type: "address",
      },
    ],
    name: "allocateTokens",
