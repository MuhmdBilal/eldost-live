export const WMPNFTAddress = "0x4b59A04E3159899b37e77ecC7d49190894F1a2A8";
export const WMPNFTAbi = [
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum WMP_NFT.CollectionType",
        name: "collectionType",
        type: "uint8",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "enum WMP_NFT.CollectionType", name: "", type: "uint8" },
    ],
    name: "collections",
    outputs: [
